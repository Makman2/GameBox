namespace GameBox.Data
{
        ...
        : IDataStreamWritable
    {
         ...
         *
         * You can register an output stream via the RegisterOutputStream()
         * function.
         */
        ...
        {
            //TODO: Wait until GLib.File supports opening a file in writeonly
