namespace GameBox.Data
{
     ...
     * to an OutputStream. This class exposes a flexible I/O interface to manage
     * data from streams.
     *
     ...
     *
     * Override the Write() and Read() methods in your derivated classes to
     * implement a specific DataStreamManagerBase that handles your data format.
     *
        ...
        : IDataStreamReadable , IDataStreamWritable
    {
         ...
         *
         * You can register input/output streams later via the
         * RegisterInputStream() and RegisterOutputStream() functions.
         */
         ...
         * (if supported, if not all access-types are supported these features
         ...
         * Instantiates a new DataStreamManagerBase.
         *
         * Only Initialize() is available but not Save() since no OutputStream
         * gets registered.
         *
         ...
         * Instantiates a new DataStreamManagerBase.
         *
         * Save() and Initialize() are both available when using this
         * constructor.
         *
         ...
         * Instantiates a new DataStreamManagerBase.
         *
         * Only Save() is available but not Initialize() since no InpuStream
         * gets registered.
         *
       ...
       /**
         ...
         * construction of this class doesn't automatically call Initialize()
         * (you are responsible for calling it when you need to read/reset from
         * the set InputStream).
         *
         ...
         */
        public void Initialize() throws IOError
        {
            ThrowIfCantRead();
            Read(m_InputStream);
        }
         ...
         *
         * @throws IOError Thrown when no OutputStream was registered or writing
         *                 to it is impossible (CanWrite() returns false).
         */
        ...
        /**
         * Just throws an exception if reading is unavailable.
         *
         * @throws IOError Thrown when reading is not possible (CanRead()
         *                 returns false).
         */
