...
namespace GameBox.Data
{
     ...
     */
    public abstract class DataStreamReadableBase : IDataStreamReadable
    {
        /**
         ...
         * streams.
         *
         * You can register an input stream later via the RegisterInputStream()
         * function.
         */
         ...
         * Registers an InputStream to read from.
         *
         * Intended for class internal use only (since this function supports
         * registering null).
         *
         * @param stream The new InputStream to register. Is a nullable type,
         *               means passing null is valid.
         */
        ...
        /**
         * Parses the data from the registered InputStream.
         *
        ...
        /**
         * (Re-)Initializes the class data with the data from the registered
         * InputStream (so CanRead() returns true). If no InputStream was
         * registered or reading from it is unavailable, this function throws
         * an exception.
         *
         ...
         *
         * @throws IOError Thrown when no InputStream was registered or reading
         *                 from the InputStream is not possible (CanRead()
         *                 returns false).
         */
         ...
         *
         * @throws IOError Thrown when reading from registered InputStream is
         *                 not possible (CanRead() returns false).
         */
