namespace GameBox.Data
{
     ...
     * GameBox.Data.DataStreamWritableBase (only OutputStream) and
    ...
    public interface IDataStreamWritable
    {
        ...
        /**
         * Shall release registered OutputStream.
         */
        public abstract void ReleaseOutputStream();

        /**
         * Shall write the data from derivatives into the registered output
         * stream.
         *
        ...
        /**
         * Shall write the data from derivatives into the OutputStream.
         *
